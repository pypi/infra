...
#FASTLY deliver
    ...
    if (!req.http.Fastly-FF
        ...
        log {"syslog "} req.service_id {" linehaul :: "} "2@" now "|" client.geo.country_code "|" req.url.path "|" tls.client.protocol "|" tls.client.cipher "|" resp.http.x-amz-meta-project "|" resp.http.x-amz-meta-version "|" resp.http.x-amz-meta-package-type "|" req.http.user-agent;
    }
